...
import { useSseQuotes } from "@/hooks/use-sse-quotes";
...
export function LiveView() {
  ...
  const { quotes, history, loading: quotesLoading, refreshing, error, lastUpdated, marketStatus, missing, resolvedCount, refresh } = useSseQuotes(holdings);
