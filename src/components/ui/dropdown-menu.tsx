...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[10rem] overflow-hidden rounded-xl border border-white/10 bg-[hsl(158_28%_10%)]/95 p-1.5 text-foreground shadow-glass backdrop-blur-2xl",
...
>(({ className, inset, destructive, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      inset && "pl-8",
      destructive &&
        "text-red-300 focus:bg-red-500/10 focus:text-red-200",
      className,
    )}
    {...props}
  />
...
// unused imports kept to make future extension easy
void Check;
void ChevronRight;
